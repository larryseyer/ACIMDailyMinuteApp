...
| Settings (appearance + reminders + practice reminders + replay onboarding + Your Work + About) | All sections | Present; Appearance picker, Daily Minute and Daily Lesson reminders each with a time, practice reminders with a day window and the reader's own place, Replay introduction, Backup & Restore, About with version + lineage | Pass | Views/Settings/SettingsView.swift |
