...
NEXT: Task 3 — Video row and Text-chapter destination (`VideoPlayableRow.swift` + `VideoTextChapterView.swift` + six pbxproj lines each). Then Tasks 4–5. Do not start tvOS Read. Do not redo Read or Listen.
...
New Swift files: `AA000002750`–`752`. Pattern: `SegmentReadingView.swift`. `VideoLibrary.swift` is registered as `AA000002750` / `AA000001750` / `C0DE0001A11CE0B1000016`. Task 3 uses `751`/`752` and `C0DE…0017`/`0018`.
