...
NEXT: implement that plan, Task 1 first (VideoLibrary + `verify_video_compose.sh`). Then Tasks 2–5. Do not start tvOS Read. Do not redo Read or Listen.
...
New Swift files: `AA000002750`–`752`. Pattern: `SegmentReadingView.swift`.
